...
<form method="POST" action="">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="NivelGrado" id="NivelGrado" 
        placeholder="Nivel del grado" value="{{$grado->NivelGrado}}">
    </div>

    <div class="form-group">
        <label for="Seccion"> Seccion </label>
        <input type="text" class="form-control" name="Seccion" id="Seccion" 
        placeholder="Seccion del grado" value="{{$grado->Seccion}}">
    </div>
