...
<form method="POST" action="">
    ...
    <div class="form-group">
        ...
        placeholder="Nombres del profesor" value="{{$profesor->Nombres}}">
    </div>

    <div class="form-group">
        <label for="PrimerApellido"> Primer Apellido </label>
        <input type="text" class="form-control" name="PrimerApellido" id="PrimerApellido" 
        placeholder="Primer Apellido del profesor" value="{{$profesor->PrimerApellido}}">
    </div>

    <div class="form-group">
        <label for="SegundoApellido"> Segundo Apellido </label>
        <input type="text" class="form-control" name="SegundoApellido" id="SegundoApellido" 
        placeholder="Segundo Apellido del profesor" value="{{$profesor->SegundoApellido}}">
    </div>

    <div class="form-group">
        <label for="Telefono"> Telefono </label>
        <input type="text" class="form-control" name="Telefono" id="Telefono" 
        placeholder="00-00-00-00" value="{{$profesor->Telefono}}">
    </div>

    <div class="form-group">
        <label for="CorreoElectronico"> Correo Electronico </label>
        <input type="text" class="form-control" name="CorreoElectronico" id="CorreoElectronico" 
        placeholder="nombre.apellido@example.com" value="{{$profesor->CorreoElectronico}}">
    </div>

    <div class="form-group">
        <label for="Sueldo"> Sueldo </label>
        <input type="text" class="form-control" name="Sueldo" id="Sueldo" 
        placeholder="0.00" value="{{$profesor->Sueldo}}">
    </div>
